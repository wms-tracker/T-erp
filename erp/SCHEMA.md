...
```json
{
  ...
  "damageType": "พื้น/ผนัง/เพดาน",
  "severity": "FAC | MTC | LTI | PTD  // เกณฑ์ระดับความรุนแรงอุบัติเหตุ คปอ./จป. 4 ระดับ: First Aid Case / Medical Treatment Case / Lost Time Injury / Fatality-Permanent Disability — ดู SEVERITY_LABEL ใน erp/js/damage-reports.js",
