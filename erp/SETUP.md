...
4. ไปที่เมนู "👥 จัดการผู้ใช้งาน & สิทธิ์" เพื่อเพิ่มพนักงานคนอื่นๆ
   - **ขั้นตอนเพิ่มพนักงาน 1 คน (ทำได้จากหน้านี้หน้าเดียว):**
     กรอกชื่อ, อีเมล, **รหัสผ่าน** (อย่างน้อย 6 ตัวอักษร), เลือก role ที่ถูกต้อง (sales/warehouse/accounting/admin/manager)
     แล้วกด "+ เพิ่มผู้ใช้งาน" — ระบบจะสร้างบัญชี Firebase Authentication และบันทึกสิทธิ์ลง Firestore ให้อัตโนมัติทั้งสองอย่าง
     (ใช้ secondary Firebase app instance เบื้องหลัง เพื่อไม่ให้แอดมินที่กำลัง login อยู่ถูกเด้งออก)
     พนักงานคนนั้น login ด้วยอีเมล/รหัสผ่านที่ตั้งได้ทันที
   - ถ้าเคยสร้างบัญชี Auth ไว้ใน Firebase Console แล้ว (Authentication → Add user) ให้เว้นช่องรหัสผ่านว่าง แล้วกรอก **UID** แทน
